  ...
  return (
    <div className='min-h-screen bg-linear-to-b from-blue-50 to-white'>
      <div className='container mx-auto px-4 py-12'>
        <h1 className='text-3xl md:text-4xl font-bold mb-12 text-center text-[#e50012]'>
          当ウェブサイトについて
        </h1>
        ...
        <div className='max-w-3xl mx-auto space-y-12'>
          ...
          <section>
            ...
            <div className='space-y-3 text-gray-700'>
              <p>
                このサイトは、ビックカメラの店舗擬人化キャラクター「ビッカメ娘」を応援する非公式ファンサイトです。
              </p>
              <p>
                ビッカメ娘の情報を整理・集約し、ファンの皆様がキャラクターをより楽しめることを目的としています。
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className='space-y-3 text-gray-700'>
              <p>
                ビッカメ娘に関する著作権は、株式会社ビックカメラおよびアイティオール株式会社に帰属します。
              </p>
              <p>
                本サイトは、
                <a
          ...
          <section>
            ...
            <div className='space-y-3 text-gray-700'>
              <p>
                本サイトで表示されるキャラクター画像は、公式サイトから参照しています。
              </p>
              <p>
                画像の複製や再配布は行っておらず、公式サーバーから直接配信されています。
              </p>
            </div>
          </section>
