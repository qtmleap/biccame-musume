      ...
      <div className='mx-auto px-4 py-2 md:py-4 md:px-8 max-w-6xl'>
        ...
        <div className='space-y-12'>
          ...
          <section>
            ...
            <div className='space-y-3 text-muted-foreground'>
              <p>ビッカメ娘に関する著作権は、株式会社ビックカメラおよびアイティオール株式会社（© itall（ガイドライン原文表記: citall））に帰属します。</p>
              <p>
                本サイトは、
                <a
                ...
                の「使用許諾」第2条に列挙される「ウェブサイト、ブログ、ＳＮＳでの本キャラクターの紹介」に基づき、非営利目的かつ無償のファン活動として運営しています。広告等を利用した収入を得ることは一切ありません。
              </p>
            </div>
          </section>
            ...
            <ol className='space-y-4 text-muted-foreground'>
              ...
              <li className='flex gap-3'>
                ...
                <div className='flex-1 space-y-1'>
                  ...
                  <p className='text-sm'>
                    本サイトはビッカメ娘の画像をそのままの形で利用するにあたり、著作権者「© itall（ガイドライン原文表記: citall）」の表示および本サイトを経由した画像の再使用の禁止を明記しています。
                  </p>
                </div>
              </li>
              <li className='flex gap-3'>
          ...
          <section>
            ...
            <div className='space-y-3 text-muted-foreground'>
              ...
              <p>
                ガイドラインに基づき、キャラクター画像の著作権は「© itall（ガイドライン原文表記: citall）」（アイティオール株式会社）に帰属することを明記いたします。
