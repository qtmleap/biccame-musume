...
export const STATUS_BADGE = componentContent.content.statusBadge
export const STATUS_BADGE_SM = componentContent.content.statusBadgeSm
export const STATUS_BADGE_DETAIL = componentContent.content.statusBadgeDetail
export const CATEGORY_STYLE = componentContent.content.categoryStyle
export const CATEGORY_WITH_ICON = componentContent.content.categoryWithIcon
export const CATEGORY_BG_COLOR = componentContent.content.categoryBgColor
